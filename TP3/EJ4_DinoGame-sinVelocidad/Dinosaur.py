...
import numpy as np
from TensorflowImageUtils import IMAGE_SIZE, MODEL_OUTPUT_CLASSES, load_and_preprocess_image
...
class Dinosaur(NeuralNetwork):
    ...
    Y_POS_DUCK = 340
    JUMP_VEL = 8.5
    PREDICTION_SMOOTHING = 0.65
    JUMP_CONFIDENCE_THRESHOLD = 0.65
    DUCK_CONFIDENCE_THRESHOLD = 0.65
    ACTION_MARGIN = 0.07
