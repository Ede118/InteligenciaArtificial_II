...
if __name__ == "__main__":
    ...
    ModeloReLU = Perceptron(
        InputDim=1, 
        OutputDim=1, 
        Neurons=np.array([1]), 
        ActivationFunction="ReLU")
    
    Y_untrained = ModeloReLU.Predict(InputVector=X_test)
    W1_untrained = ModeloReLU.WeightMatrix[0, 0]
    b_untrained = ModeloReLU.Bias[0, 0]
    ...
    W1 = ModeloReLU.WeightMatrix[0, 0]
    b = ModeloReLU.Bias[0, 0]
    ...
    Y_trained = ModeloReLU.Predict(InputVector=X_test)
    ...
    GraficarNormaGradientes(ModeloReLU, False)

    # =============================================================================== #
    #               Gráficos de evolución de la norma de los gradientes     
    # =============================================================================== #

    GraficarCurvaPerdida(ModeloReLU)
    ...
    ax.set_title('Función de activación: $g(z) = \max(0, z)$ (ReLU)', fontsize=11, fontweight='bold', pad=10)
