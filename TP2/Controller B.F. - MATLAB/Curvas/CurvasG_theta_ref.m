...
archivos = dir(fullfile(folder, 'Theta80_G_theta_ref*.mat')); % Buscamos todos los .mat
...
for i = 1:length(archivos)
    ...
    legendaTexto = sprintf('G_{\\theta_{ref}}=%.1f^\\circ', i);
...
title('Barrido de la Ganancia $G_{\theta_{ref}}$', ...
