...
for i = 1:length(archivos)
    ...
    legendaTexto = sprintf('G_{v}=%d', i+19);
...
title('Barrido de la Ganancia $G_v$', ...
...
%%
figure('Name', 'Velocidad del Carrito', 'Color', 'w');
hold on; grid on;
...
for i = 1:length(archivos)
    ...
    plot(vTime{i}, vV{i}, 'LineWidth', 1.5, 'DisplayName', legendaTexto);
end
...
xlabel('Tiempo $t$ [s]', 'Interpreter', 'latex', 'FontSize', 13);
ylabel('Velocidad $v(t)$ [m/s]', 'Interpreter', 'latex', 'FontSize', 13);
