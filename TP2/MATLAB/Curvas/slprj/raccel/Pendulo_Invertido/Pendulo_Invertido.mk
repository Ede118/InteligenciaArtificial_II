...
MAKECMD         = /usr/local/MATLAB/R2025b/bin/glnxa64/gmake -j 4 -l 4
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODULES                 = Pendulo_Invertido.c Pendulo_Invertido_capi.c Pendulo_Invertido_data.c Pendulo_Invertido_tgtconn.c rtGetInf.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = Pendulo_Invertido
MAKEFILE                = Pendulo_Invertido.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2025b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2025b
START_DIR               = /home/barrios14101/GitHub/InteligenciaArtificial_II/TP2/MATLAB/Curvas
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 4
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/usr/local/MATLAB/R2025b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/usr/local/MATLAB/R2025b/sys/os/glnxa64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Pendulo_Invertido \
